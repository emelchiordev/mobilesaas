...
object SavioInterventionColors {
    ...
    val PlanifBg = Color(0xFFE9F0F8)
    val PlanifFg = Color(0xFF2C5A8C)
    val EnCoursBg = Color(0xFFFCEED7)
    val EnCoursFg = Color(0xFFB06E08)
    val TermineeBg = Color(0xFFE2F3E9)
    val TermineeFg = Color(0xFF1E7A4F)
