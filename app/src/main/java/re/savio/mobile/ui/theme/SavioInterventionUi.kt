...
/** Tokens intervention — alignés Violett en light. */
object SavioInterventionColors {
    val BusinessAccent = ViolettTokens.Accent
    val TabUnselected = ViolettTokens.Muted
    val NotesDispatcherBg = ViolettTokens.Faint
    val NotesDispatcherText = ViolettTokens.Ink

    val PlanifBg = ViolettTokens.StatusPlanBg
    val PlanifFg = ViolettTokens.StatusPlanFg
    val EnCoursBg = ViolettTokens.StatusLiveBg
    val EnCoursFg = ViolettTokens.StatusLiveFg
    val TermineeBg = ViolettTokens.StatusDoneBg
    val TermineeFg = ViolettTokens.StatusDoneFg
