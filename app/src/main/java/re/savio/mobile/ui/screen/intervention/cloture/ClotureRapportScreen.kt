...
import re.savio.mobile.ui.refonte.SavioClotureAiButton
...
import re.savio.mobile.ui.refonte.SavioClotureNoteField
import re.savio.mobile.ui.refonte.SavioClotureReportField
...
private fun ClosureFollowUpSection(
    ...
    val content: @Composable () -> Unit = {
        ...
        if (followUpRequired) {
            SavioClotureNoteField(
                value = followUpNote,
                onValueChange = onFollowUpNoteChange,
                placeholder = "Devis à faire, pièce à commander…",
                minHeight = 96.dp,
            )
        }
    }
