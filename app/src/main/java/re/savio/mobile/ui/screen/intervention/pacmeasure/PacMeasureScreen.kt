package re.savio.mobile.ui.screen.intervention.pacmeasure
...
import re.savio.mobile.ui.screen.intervention.measure.MeasureDropdownField
import re.savio.mobile.ui.screen.intervention.measure.MeasureNumericField
...
private fun PacTabExterieur(
    state: re.savio.mobile.data.local.entity.PacMeasureEntity,
