...
data class CustomerDto(
    ...
    val email: String?,
    @SerializedName("financialDocuments")
    val financialDocuments: List<ClientFinancialDocumentDto>? = null,
    @SerializedName("financialSummarySyncedAt")
    val financialSummarySyncedAt: String? = null,
)
...
data class SettingsDto(
    ...
    @SerializedName("vatRegime")
    val vatRegime: String = "REAL_NORMAL",
    @SerializedName("canEditVatRate")
    val canEditVatRate: Boolean = true,
    @SerializedName("demoOnboardingState")
    val demoOnboardingState: String? = null,
    @SerializedName("refrigerantCapacityAttestationNumber")
    val refrigerantCapacityAttestationNumber: String? = null,
    @SerializedName("refrigerantCapacityAttestationIsDemo")
